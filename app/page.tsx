...
import { Heart, Lock, Sparkles, MailOpen, KeyRound, ShieldAlert, Gift } from "lucide-react";
      ...
      {isUnlocked && (
        <div className="max-w-4xl mx-auto space-y-24 pt-12">
          ...
          <section className="glass-panel p-8 md:p-12 rounded-3xl shadow-xl max-w-2xl mx-auto">
            ...
            <div className="prose prose-rose max-w-none font-serif text-slate-800 leading-relaxed text-base md:text-lg whitespace-pre-wrap">
